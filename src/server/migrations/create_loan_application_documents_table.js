...
async function createLoanApplicationDocumentsTable() {
  try {
    await initializeDatabase();
    console.log('Starting migration: Create loan_application_documents table');
    ...
    console.log('✅ loan_application_documents table created successfully');

  } catch (error) {
    console.error('❌ Error creating loan_application_documents table:', error);
    throw error;
  }
}
...
if (require.main === module) {
  createLoanApplicationDocumentsTable()
    .then(() => {
...
module.exports = { createLoanApplicationDocumentsTable };
