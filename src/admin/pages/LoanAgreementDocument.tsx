    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="loan-agreement-content max-w-[210mm] mx-auto my-8 print:my-0 bg-white shadow-lg print:shadow-none">
        <div className="p-12" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
          ...
          <h3 className="font-normal italic mb-2" style={{ fontSize: '8pt' }}>2.1 Definitions</h3>
          <p style={{ fontSize: '8pt', lineHeight: '1.5', textAlign: 'justify', marginBottom: '10px' }}>
          ...
          <ol type="i" start={8} style={{ fontSize: '8pt', lineHeight: '1.5', textAlign: 'justify', paddingLeft: '40px' }}>
          ...
          <h3 className="font-normal italic mb-2 mt-4" style={{ fontSize: '8pt' }}>2.2 Other terms may be defined elsewhere in the text of this Agreement and, unless otherwise indicated, shall have such meaning throughout this Agreement.</h3>

          <h3 className="font-normal italic mb-2" style={{ fontSize: '8pt' }}>2.3 Interpretation</h3>
          <ol type="i" style={{ fontSize: '8pt', lineHeight: '1.5', textAlign: 'justify', paddingLeft: '40px' }}>
          ...
          <p style={{ fontSize: '8pt', lineHeight: '1.5', textAlign: 'justify', marginBottom: '10px', marginTop: '10px' }}>
          ...
          <h3 className="font-normal italic mb-2" style={{ fontSize: '8pt' }}>8.1 Each of the following events or circumstances would constitute events of default under the terms of the Facility Documents ("Event of Default"):</h3>
          <ol type="i" style={{ fontSize: '8pt', lineHeight: '1.5', textAlign: 'justify', paddingLeft: '40px' }}>
          ...
          <h3 className="font-normal italic mb-2 mt-4" style={{ fontSize: '8pt' }}>8.2 On the occurrence of any Event of Default, the Lender is entitled to undertake any or all of the following:</h3>
          <ol type="a" style={{ fontSize: '8pt', lineHeight: '1.5', textAlign: 'justify', paddingLeft: '40px', listStyleType: 'lower-alpha' }}>
          ...
          <p className="font-bold" style={{ fontSize: '8pt', marginBottom: '10px' }}>
          ...
          {/* Signatures */}
          <div className="mt-12">
            <p className="font-bold mb-8" style={{ fontSize: '8pt' }}>For and on behalf of Lender ({agreementData.company.name})</p>
            ...
            <p style={{ fontSize: '8pt', marginBottom: '30px' }}>Reason: Loan Agreement</p>

            <p className="font-bold mb-8" style={{ fontSize: '8pt' }}>I HAVE ACCEPTED THE LOAN AGREEMENT WITH THE TERMS AND CONDITIONS THEREIN</p>
            <div style={{ width: '200px', height: '50px', border: '1px dashed #ccc', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#666', marginBottom: '10px' }}>
              Borrower Signature
            </div>
          </div>
          ...
          <table className="w-full border-collapse" style={{ fontSize: '8pt', border: '1px solid #000' }}>
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-black p-2">{maskAadhar(agreementData.borrower.aadhar || agreementData.borrower.aadhar_number)}</td>
              </tr>
              <tr>
