...
import { ArrowLeft, Phone, Users, CheckCircle, AlertCircle } from 'lucide-react';
...
export function EnhancedUserReferencesPage({
  ...
  const validateForm = () => {
    ...
    if (!alternateData.alternate_mobile.trim()) {
      toast.error('Please provide an alternate mobile number');
      return false;
    }
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Complete your loan application by providing 3 personal references and an alternate mobile number
            </p>
          </div>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`h-12 pl-16 transition-all duration-200 ${getPhoneValidationStatus(reference.phone, index) === 'valid'
        ...
        <div className="mb-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Provide an alternate contact number for verification purposes.
            </p>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="9876543210"
                  className={`h-12 pl-16 transition-all duration-200 ${getPhoneValidationStatus(alternateData.alternate_mobile) === 'valid'
                    ? 'border-green-300 focus:border-green-500 focus:ring-green-500/20'
              ...
              <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                ...
                <p className="text-xs text-amber-700">
                  Enter your alternate mobile number or any number from your family. This number cannot be the same as any reference number or your registered number.
                </p>
              </div>
            </div>
          </div>
